<template>
  <div class="reader">
    <div class="reader-imtext">
      <img src="@/assets/img/read-img.png" class="reader-imtext__image" />
      <p class="reader-text">
    ...
    <swiper v-if="images.length" :modules="[Pagination, Navigation]" navigation pagination class="reader-slider">
