...
export class PatternBuilder {
    ...
    patternData: IPatternBuild
    // capsuleRadius: number
    // pattern: TPattern
    // padding: number
    // count: TPatternCount
    // patternGeometry: THREE.BufferGeometry
    patternMesh: THREE.Mesh


    constructor(patternData: IPatternBuild) {
        this.patternData = patternData;
        this.patternMesh = this.createPatternMesh(patternData)
    }

    get _PatternMesh() {
        return this.patternMesh
    }
