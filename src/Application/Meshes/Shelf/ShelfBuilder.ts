...
export class ShelfBuilder {
    ...
    createShelfs(props: TTotalProps, shelfs: IShelfData, material: Material, move: Vector3) {
        ...
        const createShelves = (
            ...
            shelfs[axis].forEach((shelfExpression, index) => {
                ...
                const mesh = new Mesh(geometry, shelfMaterial);
    ...
    buildShelves(props: TTotalProps) {
        const total = props.CONFIG.SHELFQUANT.total
        const current = props.CONFIG.SHELFQUANT.current
